...
class Options_Framework_Interface {
	...
	static function optionsframework_fields() {
		...
		foreach ( $options as $value ) {
			...
			// Wrap all options
			if ( ( $value['type'] != "heading" ) && ( $value['type'] != "infotext" ) && ( $value['type'] != "info" ) && ( $value['type'] != "protext" ) && ( $value['type'] != "adstwofifty" ) && ( $value['type'] != "innertabopen" ) && ( $value['type'] != "innertabclose" ) && ( $value['type'] != "tabheading" ) && ( $value['type'] != "groupcontaineropen" ) && ( $value['type'] != "groupcontainerclose" ) ) {
			...
			case "heading":
				...
				case "protext":
					...
					$output .= '<div class="proupgradetext"><p>' . esc_html( $value['desc'] ) . '</p></div>';
